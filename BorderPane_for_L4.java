...
public class BorderPane_for_L4 extends BorderPane {
	
	//We create these panes and then add them to the border pane.
	
	Game_Board4 game_board4 = new Game_Board4();
	Top_Board4 top_board4 = new Top_Board4();
	Bottom_Board4 bottom_board4 = new Bottom_Board4();
	...
	public BorderPane_for_L4() {

		setCenter(game_board4);
		setTop(top_board4);
		setBottom(bottom_board4);
	}


//**************************************************************************
//the game board is a GridPane. It contains 100 rectangles.
class Game_Board4 extends GridPane {
	...
	public void build() {
		...
		for(int i = 0;i<10;i++) {
			for(int j = 0;j<10;j++) {
				...
				top_board4.getChildren().clear();
				top_board4.getChildren().add(name);
				top_board4.getChildren().add(point);
				top_board4.getChildren().add(score);
		...
		//These are just settings for level-4.
				...
				r_list[2][6].setFill(Color.PURPLE);r_list[2][6].setDestroyable(true);
				r_list[3][6].setFill(Color.PURPLE);r_list[3][6].setDestroyable(true);
				...
				r_list[6][6].setFill(Color.PURPLE);r_list[6][6].setDestroyable(true);
				r_list[7][6].setFill(Color.PURPLE);r_list[7][6].setDestroyable(true);
				...
				r_list[2][7].setFill(Color.PURPLE);r_list[2][7].setDestroyable(true);
				r_list[3][7].setFill(Color.PURPLE);r_list[3][7].setDestroyable(true);
				r_list[4][7].setFill(Color.PURPLE);r_list[4][7].setDestroyable(true);
				r_list[5][7].setFill(Color.PURPLE);r_list[5][7].setDestroyable(true);
				r_list[6][7].setFill(Color.PURPLE);r_list[6][7].setDestroyable(true);
				r_list[7][7].setFill(Color.PURPLE);r_list[7][7].setDestroyable(true);
				...
				r_list[2][2].setFill(Color.BLUE);r_list[2][2].setDestroyable(true);
				r_list[3][2].setFill(Color.BLUE);r_list[3][2].setDestroyable(true);
				r_list[4][2].setFill(Color.BLUE);r_list[4][2].setDestroyable(true);
				r_list[5][2].setFill(Color.BLUE);r_list[5][2].setDestroyable(true);
				r_list[6][2].setFill(Color.BLUE);r_list[6][2].setDestroyable(true);
				r_list[7][2].setFill(Color.BLUE);r_list[7][2].setDestroyable(true);
				r_list[8][2].setFill(Color.BLUE);r_list[8][2].setDestroyable(true);
				r_list[1][3].setFill(Color.BLUE);r_list[1][3].setDestroyable(true);
				r_list[2][3].setFill(Color.BLUE);r_list[2][3].setDestroyable(true);
				r_list[3][3].setFill(Color.BLUE);r_list[3][3].setDestroyable(true);
				r_list[4][3].setFill(Color.BLUE);r_list[4][3].setDestroyable(true);
				r_list[5][3].setFill(Color.BLUE);r_list[5][3].setDestroyable(true);
				r_list[6][3].setFill(Color.BLUE);r_list[6][3].setDestroyable(true);
				r_list[7][3].setFill(Color.BLUE);r_list[7][3].setDestroyable(true);
	...
	public void destroy_all(rectangle r) {
		...
		if(i==0 && j==0 && r.IsDestroyable() ) {
			if(r_list[i][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().clear();
				bottom_board4.getChildren().add(box);
			}
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit1);
			}
			if(r_list[i][j+1].IsDestroyable()) {
				r_list[i][j+1].destroy();
				counter +=1;
				Label hit2 = new Label("					Hit:" + i +"-" + (j+1));
				bottom_board4.getChildren().add(hit2);
				}
			//according to counter value we need to print bottom page the value of gained or lost points
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
				bottom_board4.getChildren().add(new Label("															(-1 points)"));
			else if (counter == 3)
				bottom_board4.getChildren().add(new Label("															(+1 points)"));
			else if (counter ==4)
				bottom_board4.getChildren().add(new Label("															(+2 points)"));
			else if (counter == 5)
				bottom_board4.getChildren().add(new Label("															(+4 points)"));
			...
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit3);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit4 = new Label("					Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit4);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i-1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit5);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit6 = new Label("					Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit6);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i-1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit7);
				}
			if(r_list[i][j+1].IsDestroyable()) {
				r_list[i][j+1].destroy();
				counter +=1;
				Label hit8 = new Label("						Hit:" + i +"-" + (j+1));
				bottom_board4.getChildren().add(hit8);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit9);
				}
			if(r_list[i][j+1].IsDestroyable()) {
				r_list[i][j+1].destroy();
				counter +=1;
				Label hit10 = new Label("					Hit:" + i +"-" + (j+1));
				bottom_board4.getChildren().add(hit10);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit11 = new Label("				Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit11);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit12);
				}
			if(r_list[i-1][j].IsDestroyable()) {
				r_list[i-1][j].destroy();
				counter +=1;
				Label hit13 = new Label("						Hit:" + (i-1) +"-" + j);
				bottom_board4.getChildren().add(hit13);
				}
			if(r_list[i][j+1].IsDestroyable()) {
				r_list[i][j+1].destroy();
				counter +=1;
				Label hit14 = new Label("								Hit:" + i +"-" + (j+1));
				bottom_board4.getChildren().add(hit14);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i][j+1].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit15);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit16 = new Label("						Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit16);
				}
			if(r_list[i-1][j].IsDestroyable()) {
				r_list[i-1][j].destroy();
				counter +=1;
				Label hit17 = new Label("								Hit:" + (i-1) +"-" + j);
				bottom_board4.getChildren().add(hit17);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit18);
				}
			if(r_list[i-1][j].IsDestroyable()) {
				r_list[i-1][j].destroy();
				counter +=1;
				Label hit19 = new Label("						Hit:" + (i-1) +"-" + j);
				bottom_board4.getChildren().add(hit19);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit20 = new Label("								Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit20);
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
			else if (counter == 2)
			...
			if(r_list[i+1][j].IsDestroyable()) {
				...
				bottom_board4.getChildren().add(hit21);
				}
			if(r_list[i-1][j].IsDestroyable()) {
				r_list[i-1][j].destroy();
				counter +=1;
				Label hit22 = new Label("						Hit:" + (i-1) +"-" + j);
				bottom_board4.getChildren().add(hit22);
				}
			if(r_list[i][j-1].IsDestroyable()) {
				r_list[i][j-1].destroy();
				counter +=1;
				Label hit23 = new Label("								Hit:" + i +"-" + (j-1));
				bottom_board4.getChildren().add(hit23);
				}
			if(r_list[i][j+1].IsDestroyable()) {
				r_list[i][j+1].destroy();
				Label hit24 = new Label("										Hit:" + i +"-" + (j+1));
				bottom_board4.getChildren().add(hit24);
				counter +=1;
				}
			if (counter == 1)
				bottom_board4.getChildren().add(new Label("															(-3 points)"));
      ...
      //When our level is completed , we print the next level is available now! message to the bottom page.
        if(is_it_done == true && r_count == 100) {
            ...
            bottom_board4.setPadding(new Insets(30,30,30,30));
            bottom_board4.getChildren().add(nextLevel);
            nextLevel.setLayoutX(220);
            nextLevel.setLayoutY(13);
         
        }
	}//end of the destroy all function.
}// end of the game board 4.

//**************************************************************************
//This is the top board of the level-4
class Top_Board4 extends HBox{
...
//**************************************************************************
//This is the bottom board of the level-4
class Bottom_Board4 extends Pane{
	
	public Bottom_Board4() {
		build();
	}
